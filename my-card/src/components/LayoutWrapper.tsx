...
const LayoutWrapper: FC<LayoutWrapperProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen w-full overflow-hidden relative flex items-center justify-center">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full max-w-3xl px-2 py-8 
        ...
        <span className="absolute top-2 left-2 font-tacteng text-6xl md:text-9xl text-yellow-500/80 animate-fadeIn">*</span>
        <div className="absolute top-2 left-1/2 -translate-x-1/2 flex">
          <span className="font-tacteng text-5xl md:text-8xl text-yellow-500/80 animate-fadeIn">&</span>
          <span className="font-tacteng text-5xl md:text-8xl text-yellow-500/80 animate-fadeIn">'</span>
        </div>
        <span className="absolute top-2 right-2 font-tacteng text-6xl md:text-9xl text-yellow-500/80 animate-fadeIn">+</span>

        {children}

        <span className="absolute bottom-2 left-2 font-tacteng text-6xl md:text-9xl text-yellow-500/80 animate-fadeIn">,</span>
        <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex">
          <span className="font-tacteng text-5xl md:text-8xl text-yellow-500/80 animate-fadeIn">(</span>
          <span className="font-tacteng text-5xl md:text-8xl text-yellow-500/80 animate-fadeIn">)</span>
        </div>
        <span className="absolute bottom-2 right-2 font-tacteng text-6xl md:text-9xl text-yellow-500/80 animate-fadeIn">-</span>
      </div>
    </div>
  );
};
